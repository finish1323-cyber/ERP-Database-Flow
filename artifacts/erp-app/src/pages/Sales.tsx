...
export function Sales() {
  ...
  const handleStatusUpdate = (e: React.FormEvent) => {
    ...
    const total = typeof editingInv.total === "string" ? parseFloat(editingInv.total) : editingInv.total;
    updateMut.mutate({
      id: editingInv.id,
      data: {
        orderId: editingInv.orderId,
        invoiceNumber: editingInv.invoiceNumber,
        issuedAt: editingInv.issuedAt,
        total,
        status: statusVal,
    ...
    <div className="space-y-6">
      ...
      <div className="bg-card rounded-2xl shadow-sm border border-border p-6">
        <div className="flex justify-between mb-6">
          ...
          <Dialog open={addOpen} onOpenChange={(o) => { setAddOpen(o); setFormData(newInvoiceForm()); }}>
              ...
              <form onSubmit={handleCreate} className="space-y-4 pt-4">
                <div className="space-y-2">
                  ...
                  <Select value={formData.orderId.toString()} onValueChange={v => {
                    ...
                    setFormData({ ...formData, orderId: parseInt(v), total });
                  }}>
                ...
                <div className="space-y-2"><label className="text-sm">الإجمالي</label><Input type="number" step="0.01" required value={formData.total} onChange={e => setFormData({ ...formData, total: parseFloat(e.target.value) || 0 })} /></div>
        ...
        <Dialog open={editOpen} onOpenChange={setEditOpen}>
          <DialogContent dir="rtl">
            ...
            <form onSubmit={handleStatusUpdate} className="space-y-4 pt-4">
              <Select value={statusVal} onValueChange={(v: InvoiceStatus) => setStatusVal(v)}>
